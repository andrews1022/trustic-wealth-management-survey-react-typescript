...
const IntroSvg = () => (
	...
	>
		...
		<rect x='425.54' y='262.05' width='38.91' height='81.16' fill='#4834ae' opacity='0.5' />
		<rect x='492.25' y='212.02' width='38.91' height='131.2' fill='#4834ae' opacity='0.8' />
		<rect x='558.96' y='165.32' width='38.91' height='177.89' fill='#4834ae' />
		<polyline
		...
		<circle cx='512.26' cy='173.11' r='7.78' fill='#4834ae' />
		<circle cx='378.84' cy='184.22' r='7.78' fill='#4834ae' />
		<circle cx='577.86' cy='145.31' r='7.78' fill='#4834ae' />
		<path
		...
		<circle cx='39.3' cy='210.4' r='7.23' fill='#4834ae' />
		<circle cx='106.2' cy='171.53' r='7.23' fill='#4834ae' />
		<circle cx='106.2' cy='282.72' r='7.23' fill='#4834ae' />
		<circle cx='94.45' cy='200.46' r='7.23' fill='#4834ae' />
		<circle cx='108.91' cy='330.64' r='7.23' fill='#4834ae' />
		<circle cx='60.09' cy='311.65' r='7.23' fill='#4834ae' />
		<circle cx='101.68' cy='231.19' r='7.23' fill='#4834ae' />
	</svg>
);
